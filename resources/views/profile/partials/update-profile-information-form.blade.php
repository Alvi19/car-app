    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="driver_license" name="driver_license" type="text" class="mt-1 block w-full"
                :value="old('driver_license', $user->driver_license)" required autofocus autocomplete="driver_license" />
        ...
        <div>
            ...
            <textarea id="address" name="address"
                ...
                style="height: 120px;" required autofocus autocomplete="address">{{ old('address', $user->address) }}</textarea>
