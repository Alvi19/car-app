<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="driver_license" class="block mt-1 w-full" type="text" name="driver_license"
                :value="old('driver_license')" required autofocus autocomplete="driver_license" />
